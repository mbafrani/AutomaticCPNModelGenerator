...
DECLARATION_COLOR_DATA = "DATA"
DECLARATION_COLOR_DATA_DATATYPE = "string"
DECLARATION_COLOR_CASE_ID_X_DATA = "CASE_IDxDATA"
DECLARATION_COLOR_DATA_VARIABLE = "data"
DECLARATION_COLOR_DATA_VARIABLE_VALUE = "case data"
DECLARATION_COLOR_CASE_ID_X_DATA_INIT_VARIABLE = "(" + DECLARATION_COLOR_CASE_ID_VARIABLE + ", \"" + DECLARATION_COLOR_DATA_VARIABLE_VALUE + "\")"
DECLARATION_COLOR_CASE_ID_X_DATA_VARIABLE = "(" + DECLARATION_COLOR_CASE_ID_VARIABLE + ", " + DECLARATION_COLOR_DATA_VARIABLE + ")"
