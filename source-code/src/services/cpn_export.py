...
class CPNExportService:
  ...
  def create_globbox_element_for_document(self, document):
    ...
    colorid_tag.appendChild(document.createTextNode(str(constants.DECLARATION_COLOR_REQUEST)))
    ...
    colorml_tag.appendChild(document.createTextNode(str(constants.DECLARATION_COLOR_REQUEST_ITER_INDEX_START)))
    colorindex_tag.appendChild(colorml_tag)
    colorml_tag = document.createElement("ml")
    colorml_tag.appendChild(document.createTextNode(str(constants.DECLARATION_COLOR_REQUEST_ITER_INDEX_END)))
    colorindex_tag.appendChild(colorml_tag)
    colorindexid_tag = document.createElement("id")
    colorindexid_tag.appendChild(document.createTextNode(str(constants.DECLARATION_COLOR_REQUEST_ITER_INSTANCE)))
    ...
    vartypeid_tag.appendChild(document.createTextNode(str(constants.DECLARATION_COLOR_REQUEST)))
    vartype_tag.appendChild(vartypeid_tag)
    var_tag.appendChild(vartype_tag)
    
    varid_tag = document.createElement("id")
    varid_tag.appendChild(document.createTextNode(str(constants.DECLARATION_COLOR_REQUEST_VARIABLE)))
  ...
  def create_page_element_for_document(self, document, petri_net, initial_marking, final_marking, parameters=None):
    # <page>
    ...
    for place in petri_net.places:
        ...
        posattr_tag.setAttribute("x", str(place.properties[constants.LAYOUT_INFORMATION_PETRI][0][0]))
        posattr_tag.setAttribute("y", str(place.properties[constants.LAYOUT_INFORMATION_PETRI][0][1]))
        ...
        ellipse_tag.setAttribute("h", str(place.properties[constants.LAYOUT_INFORMATION_PETRI][1][0]))
        ellipse_tag.setAttribute("w", str(place.properties[constants.LAYOUT_INFORMATION_PETRI][1][1]))
        ...
        text_tag = document.createElement("text")
        text_tag.appendChild(document.createTextNode(str(constants.DECLARATION_COLOR_REQUEST)))
        ...
        if place in initial_marking.keys():
            ...
            text_tag = document.createElement("text")
            text_tag.appendChild(document.createTextNode(str(constants.DECLARATION_COLOR_REQUEST_INSTANCES)))
    ...
    for trans in petri_net.transitions:
        ...
        posattr_tag = document.createElement("posattr")
        posattr_tag.setAttribute("x", str(trans.properties[constants.LAYOUT_INFORMATION_PETRI][0][0]))
        posattr_tag.setAttribute("y", str(trans.properties[constants.LAYOUT_INFORMATION_PETRI][0][1]))
        ...
        box_tag.setAttribute("h", str(trans.properties[constants.LAYOUT_INFORMATION_PETRI][1][0]))
        box_tag.setAttribute("w", str(trans.properties[constants.LAYOUT_INFORMATION_PETRI][1][1]))
    ...
    for arc in petri_net.arcs:
        ...
        posattr_tag = document.createElement("posattr")
        posattr_tag.setAttribute("x", str(arc.properties[constants.LAYOUT_INFORMATION_PETRI][0][0]))
        # move y position by 5 else the arc annotation will end up lying on the arc
        posattr_tag.setAttribute("y",str(arc.properties[constants.LAYOUT_INFORMATION_PETRI][0][1] + 5))
  ...
  def create_cpn_model_from_petri_net(self, petri_net, initial_marking, final_marking, parameters=None):
    ...
    # <page>
    page_tag = self.create_page_element_for_document(document, petri_net, initial_marking, final_marking, parameters=None)
  ...
  def get_cpn_file_path(self, event_log_id):
    ...
    cpn_file_path = os.path.join(
      ...
      event_log_id, 
      current_app.config["CPN_MODEL_DEFAULT_NAME"] + "." + cpn_file_extension
    )
